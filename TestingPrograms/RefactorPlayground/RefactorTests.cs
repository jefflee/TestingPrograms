...
internal class RefactorTests
{
    ...
    public void ReflectionWithGenerics_TypeName()
    {
        ...
        Console.WriteLine(
            genericDicType); // Output: System.Collections.Generic.Dictionary`2[System.String,System.Int32]

        // Create an Instance by reflection
        var dicObjInstance = Activator.CreateInstance(genericDicType);
        Console.WriteLine(
            dicObjInstance); // Output: System.Collections.Generic.Dictionary`2[System.String,System.Int32]
